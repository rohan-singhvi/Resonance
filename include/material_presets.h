...
static const Entry TABLE[] = {
    ...
    { "drywall",        { 0.08f, 0.11f, 0.05f, 0.03f, 0.03f, 0.03f, 0.03f } },
    { "plaster",        { 0.03f, 0.03f, 0.02f, 0.03f, 0.04f, 0.05f, 0.05f } },
    { "wood_panel",     { 0.28f, 0.22f, 0.17f, 0.09f, 0.10f, 0.11f, 0.11f } },
    { "wood_floor",     { 0.15f, 0.11f, 0.10f, 0.07f, 0.06f, 0.07f, 0.07f } },
    ...
    { "acoustic_panel", { 0.28f, 0.44f, 0.68f, 0.82f, 0.90f, 0.88f, 0.88f } },
